...
1. Go to the extracted folder.
1. Create a *shortcut* of `Launch_DARK.bat` file.
...
<p align=center>
  <a href="https://github.com/JustABeginning/Windows-DARK#JAB">
    <img src="Images/Install_DARK.gif" alt="Install Guide for Windows DARK">
  </a>
</p>
...
[![Set System Time Format](Images/Time_Format.gif)](https://github.com/JustABeginning/Windows-DARK#JAB)
...
1. Delete the `Launch_DARK.bat` *shortcut* from the location which opens in **step-3** of ***Install***.
